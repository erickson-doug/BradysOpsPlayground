...
namespace Microsoft.Azure.Management.ApiApps
{
    ...
    /// </summary>
    public partial interface ITemplateOperations
    {
        /// <summary>
        ...
        /// request ID.
        /// </returns>
        Task<GetDeploymentTemplateMetadataResponse> GetMetadataAsync(GetDeploymentMetadataRequest parameters, CancellationToken cancellationToken);
    }
}
